...
export const RootParcel = props => {
    ...
    const parcel = React.useRef(null);
    ...
    React.useEffect(() => {
        if (!parcelNodeRef.current || isMounted.current)
            return;
    ...
    return React.createElement("div", { ref: parcelNodeRef });
};
//# sourceMappingURL=root-parcel.js.map